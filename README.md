...
[![Gem Version](https://badge.fury.io/rb/ramaze-active_action.svg)](https://badge.fury.io/rb/ramaze-active_action)
[![License MIT](https://img.shields.io/github/license/lukaszsliwa/ramaze-active_action)](https://github.com/lukaszsliwa/ramaze-active_action/blob/main/LICENSE)
[![GitHub issues](https://img.shields.io/github/issues/lukaszsliwa/ramaze-active_action)](https://github.com/lukaszsliwa/ramaze-active_action/issues)
...
```ruby
gem 'ramaze-active_action', '~> 3.0.1'
```
